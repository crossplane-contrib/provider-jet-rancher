...
func (tr *V2) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"cluster_registration_token": "status.atProvider.clusterRegistrationToken", "cluster_registration_token[*].token": "status.atProvider.clusterRegistrationToken[*].token", "kube_config": "status.atProvider.kubeConfig"}
}
