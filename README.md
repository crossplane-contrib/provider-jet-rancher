...
to the [latest release](https://github.com/crossplane-contrib/provider-jet-rancher/releases):
```
...
open an [issue](https://github.com/crossplane-contrib/provider-jet-rancher/issues).
...
provider-jet-rancher is run according to the same
...
provider-jet-rancher adheres to the same [Code of
Conduct](https://github.com/crossplane/crossplane/blob/master/CODE_OF_CONDUCT.md)
as the core Crossplane project.

## Licensing

provider-jet-rancher is under the Apache 2.0 license.
